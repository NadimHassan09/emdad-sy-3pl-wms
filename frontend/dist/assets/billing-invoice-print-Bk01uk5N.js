import{h as c,r as p,l as g}from"./billing-invoice-display-DvU1AErL.js";import{o as b,e as t}from"./task-print-html-Cj7Z0H4f.js";import{a as s,f as l}from"./billing-plan-overview-C8mi46Bm.js";const a=["subscription","inbound","outbound","packaging","quality_check","excess_volume","excess_weight"],d={subscription:"Fixed subscription",inbound:"Inbound totals",outbound:"Outbound totals",packaging:"Packaging totals",quality_check:"Quality check totals",excess_volume:"Volume charges",excess_weight:"Weight charges"};function n(e,i){return`<div class="field"><label>${t(e)}</label><div>${t(i)}</div></div>`}function y(e){return a.map(i=>{const o=g(e,i);return`<tr>
      <td>${t(d[i])}</td>
