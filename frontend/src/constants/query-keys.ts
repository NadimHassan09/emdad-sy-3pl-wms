...
export const QK = {
  ...
  contractsFinalContract: ['contracts', 'final-contract'] as const,
  notifications: {
  ...
  backups: {
    ...
    driveRetentionPolicies: ['backups', 'retention', 'drive', 'policies'] as const,
    driveRetentionPreview: ['backups', 'retention', 'drive', 'preview'] as const,
    driveRetentionAudit: ['backups', 'audit', 'drive-retention'] as const,
