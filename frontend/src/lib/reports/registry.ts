...
export const REPORT_REGISTRY: ReportDefinition[] = [
  ...
  },
  {
    ...
    columns: [
      col('location', 'Client', 'العميل', { sortable: true }),
      col('type', 'Basis', 'الأساس', { sortable: true }),
      col('skuCount', 'Used CBM', 'المستخدم CBM', { sortable: true, className: 'text-end' }),
      col('totalQty', 'Reserved CBM', 'المحجوز CBM', { sortable: true, className: 'text-end' }),
