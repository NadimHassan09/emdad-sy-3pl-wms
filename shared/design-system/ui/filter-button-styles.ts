...
export const FILTER_APPLY_BUTTON_CLASS =
  '!rounded-[10px] border border-[#10B981] bg-[#10B981] px-3 py-3 text-sm font-semibold text-white shadow-sm ' +
...
export const FILTER_RESET_BUTTON_CLASS =
  'rounded-[10px] border-rose-600 bg-rose-600 px-3 py-3 text-sm font-semibold text-white shadow-sm ' +
