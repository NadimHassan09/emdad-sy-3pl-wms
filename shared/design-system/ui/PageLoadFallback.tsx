...
export function PageLoadFallback() {
  return (
    <div className="p-3 sm:p-4 space-y-3 animate-pulse">
      ...
      <div className="pb-3 mb-2 border-b border-neutral-100 space-y-1.5">
      ...
      <div className="rounded-card border border-neutral-200 overflow-hidden shadow-sm">
        {/* Table header */}
        <div className="flex gap-3 px-3 py-1.5 bg-neutral-50 border-b border-neutral-200">
        ...
        {Array.from({ length: 8 }).map((_, i) => (
          <div
            key={i}
            className="flex gap-3 px-3 py-2 border-b border-neutral-100 last:border-0"
