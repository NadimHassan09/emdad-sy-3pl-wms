    ...
    >
      {steps.map((step, idx) => {
        ...
        const dotCn = cn(
          ...
          state === 'done' && cancelled && 'bg-text-faint',
        ...
        const labelCn = cn(
          ...
          state === 'done' && !cancelled && 'text-text-muted',
          state === 'done' && cancelled && 'text-text-faint',
          state === 'current' && !error && !cancelled && 'text-brand-700 dark:text-brand-400',
        ...
        const lineCn = cn(
          ...
          state === 'done' && cancelled && 'bg-border-strong',
          (state === 'current' || state === 'upcoming') && 'bg-border',
        );
