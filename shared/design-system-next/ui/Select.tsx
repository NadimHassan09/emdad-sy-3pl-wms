    ...
    >
      {(slots) => (
        <select
          ...
          required={required}
          className={cn(
            'block w-full bg-surface-panel border rounded-lg ps-3 pe-9 text-text-strong',
            'transition-colors duration-fast ease-standard',
            'appearance-none',
            'bg-no-repeat bg-[length:1rem_1rem]',
            // chevron — uses currentColor neutral-500 (legible on both themes)
            "bg-[url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='%2394a3b8'><path d='M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z'/></svg>\")]",
