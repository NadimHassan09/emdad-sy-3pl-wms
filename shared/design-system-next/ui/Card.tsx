  ...
  return (
    <div
      className={cn(
        ...
        'border-b border-border-subtle bg-surface-card-muted',
        'rounded-t-card',
        className,
      )}
      {...rest}
...
function CardTitle({ className, children, ...rest }: HTMLAttributes<HTMLHeadingElement>) {
  return (
    <h3
      className={cn('text-sm font-semibold text-text-strong m-0 leading-snug', className)}
      {...rest}
    >
      {children}
    </h3>
  ...
  return (
    <div
      className={cn(
        ...
        'px-3 py-2',
        'border-t border-border-subtle bg-surface-card-muted',
        'rounded-b-card',
        className,
      )}
      {...rest}
