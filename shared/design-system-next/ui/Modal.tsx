        ...
        >
          ...
          <div
            className={cn(
              ...
              'px-5 py-5 text-sm text-text-body',
          ...
          {footer && (
            <div
              className={cn(
                ...
                'px-5 py-3.5',
                'border-t border-border bg-surface-card-muted',
                'rounded-b-2xl',
              )}
            >
              {footer}
    ...
    return (
      <div
        ...
        className={cn(
          ...
          'px-5 py-4',
          'border-b border-border bg-surface-panel',
        )}
      >
        <div className="flex-1 min-w-0">
          {title && (
            <h2
              id={titleId}
              className="text-base font-semibold leading-snug text-text-strong m-0"
            >
              {title}
            </h2>
          )}
