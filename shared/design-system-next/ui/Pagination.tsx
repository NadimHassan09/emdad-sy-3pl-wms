  ...
  return (
    <div
      className={cn(
        ...
        'border-t border-border bg-surface-panel',
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-3 text-sm text-text-body">
        {!compact && onPageSizeChange && (
          <span className="flex items-center gap-2 whitespace-nowrap">
            ...
            <select
              ...
              className={cn(
                'h-8 rounded-md border border-border-strong bg-surface-panel px-2 py-0',
        ...
        <span className="text-xs text-text-muted tabular-nums">{countLabel}</span>
      </div>
