...
exports.ClientOmsReturnsController = void 0;
...
const oms_return_dto_1 = require("../../oms-returns/dto/oms-return.dto");
...
const client_oms_returns_service_1 = require("./client-oms-returns.service");
let ClientOmsReturnsController = class ClientOmsReturnsController {
    returns;
    constructor(returns) {
...
exports.ClientOmsReturnsController = ClientOmsReturnsController;
__decorate([
    (0, common_1.Get)(),
...
], ClientOmsReturnsController.prototype, "list", null);
__decorate([
    (0, common_1.Get)(':id'),
    __param(0, (0, client_user_decorator_1.ClientUser)()),
    ...
    __metadata("design:returntype", void 0)
], ClientOmsReturnsController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, client_user_decorator_1.ClientUser)()),
    ...
    __metadata("design:returntype", void 0)
], ClientOmsReturnsController.prototype, "create", null);
exports.ClientOmsReturnsController = ClientOmsReturnsController = __decorate([
    (0, public_decorator_1.Public)(),
    (0, common_1.UseGuards)(jwt_client_auth_guard_1.JwtClientAuthGuard),
    (0, common_1.Controller)('client/oms/returns'),
    __metadata("design:paramtypes", [client_oms_returns_service_1.ClientOmsReturnsService])
], ClientOmsReturnsController);
//# sourceMappingURL=client-oms-returns.controller.js.map