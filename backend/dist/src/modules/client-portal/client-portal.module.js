...
exports.ClientPortalModule = ClientPortalModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [client_auth_controller_1.ClientAuthController, client_stock_controller_1.ClientStockController],
        providers: [client_auth_service_1.ClientAuthService, client_stock_service_1.ClientStockService, jwt_client_strategy_1.JwtClientStrategy, jwt_client_auth_guard_1.JwtClientAuthGuard],
