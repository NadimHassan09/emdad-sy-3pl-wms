...
exports.ADMIN_OUTBOUND_EXPORT_COLUMNS = exports.ADMIN_INBOUND_EXPORT_COLUMNS = exports.ADMIN_OMS_EXPORT_COLUMNS = void 0;
exports.adminHeaderLabels = adminHeaderLabels;
exports.adminOrderedColumnIds = adminOrderedColumnIds;
exports.ADMIN_OMS_EXPORT_COLUMNS = [
...
exports.ADMIN_OUTBOUND_EXPORT_COLUMNS = [
    { id: 'order_number', labelEn: 'Order #', labelAr: 'رقم الطلب' },
    { id: 'status', labelEn: 'Status', labelAr: 'الحالة' },
    { id: 'company_id', labelEn: 'Company ID', labelAr: 'معرف الشركة' },
    { id: 'company_name', labelEn: 'Company', labelAr: 'الشركة' },
...
function adminOrderedColumnIds(columns, columnIds) {
    if (!columnIds?.length)
        return columns.map((c) => c.id);
    const allowed = new Set(columns.map((c) => c.id));
    return columnIds.filter((id) => allowed.has(id));
}
//# sourceMappingURL=admin-order-export.columns.js.map