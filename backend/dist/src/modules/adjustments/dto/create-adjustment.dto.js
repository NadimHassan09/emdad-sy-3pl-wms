...
exports.CreateAdjustmentDto = exports.ADJUSTMENT_REASON_PENDING = void 0;
const class_transformer_1 = require("class-transformer");
const class_validator_1 = require("class-validator");
const is_uuid_loose_1 = require("../../../common/validators/is-uuid-loose");
exports.ADJUSTMENT_REASON_PENDING = '(pending)';
function hasNonEmptyReasonString(value) {
...
], CreateAdjustmentDto.prototype, "companyId", void 0);
__decorate([
    (0, is_uuid_loose_1.IsUuidLoose)(),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.ValidateIf)((_, v) => hasNonEmptyReasonString(v)),
