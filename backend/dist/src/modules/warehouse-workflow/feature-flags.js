...
exports.allocateOnOrderCreate = allocateOnOrderCreate;
...
function allocateOnOrderCreate(config) {
    return (config.get('ALLOCATE_ON_ORDER_CREATE') ?? '').trim().toLowerCase() === 'true';
}
