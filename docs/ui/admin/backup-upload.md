...
**App:** Admin Dashboard
**Route(s):** `/settings/backups/upload`
**Source:** `frontend/src/pages/settings/BackupUploadPage.tsx`
**Nav label:** Settings → Upload

## Purpose

Upload database dump with audit panel.
...
- Settings forms on this page (Upload form).
