...
**App:** Admin Dashboard
**Route(s):** `/settings/backups/factory-reset`
**Source:** `frontend/src/pages/settings/BackupFactoryResetPage.tsx`
**Nav label:** Settings → Factory Reset

## Purpose

Wipe/reseed system with strong confirmation.
...
- Settings forms on this page (Reset confirmation form).
...
**super_admin only**. Super-admin-only tabs redirect others home.
