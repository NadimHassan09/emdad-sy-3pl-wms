...
**App:** Admin Dashboard
**Route(s):** `/settings/backups/google-drive`
**Source:** `frontend/src/pages/settings/BackupGoogleDrivePage.tsx`
**Nav label:** Settings → Google Drive

## Purpose

Connect/sync Google Drive backups (feature flagged).
...
- Settings forms on this page (Connect/sync controls).
...
Feature flag + mutate sa. Super-admin-only tabs redirect others home.
