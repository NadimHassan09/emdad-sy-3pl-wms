...
**App:** Admin Dashboard
**Route(s):** `/settings/backups/schedules`
**Source:** `frontend/src/pages/settings/BackupSchedulesPage.tsx`
**Nav label:** Settings → Scheduled Backups

## Purpose

CRUD schedules; run/delete confirms.
...
- Settings forms on this page (Schedules table).
...
mutate for write. Super-admin-only tabs redirect others home.
