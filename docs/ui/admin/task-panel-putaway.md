# Task panel — Putaway / Quarantine putaway

**App:** Admin Dashboard
**Route(s):** Inside `/tasks/:id` for `putaway` / `putaway_quarantine`
**Source:** `frontend/src/pages/tasks/putaway/PutawayExecutionPanel.tsx`
**Nav label:** Tasks execution (panel)

## Purpose

Direct received inventory into destination locations (including quarantine).
...
- Destination location picker + qty confirmation.
...
- Barcode/print helpers as implemented.
