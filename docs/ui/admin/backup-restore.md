...
**App:** Admin Dashboard
**Route(s):** `/settings/backups/restore`
**Source:** `frontend/src/pages/settings/BackupRestorePage.tsx`
**Nav label:** Settings → Restore
...
- Settings forms on this page (Restore form).
